...
<body>
    ...
    <div class="main">
    <h2>Promo -
        <span id="lblHeading">Upload</span></h2>
    ...
    <section>
        ...
        <div class="required-checklist-table">
            <table cellspacing="0">
                <tr>
                    <td>
                        <input id="ckbFirstName" type="checkbox" name="ckbFirstName" checked="checked" disabled="disabled" /><label for="ckbFirstName">First Name</label>
                    </td>
                    <td>
                        <input id="ckbReqFirstName" type="checkbox" name="ckbReqFirstName" checked="checked" disabled="disabled"/><label for="ckbReqFirstName">Required?</label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input id="ckbLastName" type="checkbox" name="ckbLastName" checked="checked" disabled="disabled"/><label for="ckbLastName">Last Name</label>
                    </td>
                    <td>
                        <input id="ckbReqLastName" type="checkbox" name="ckbReqLastName" checked="checked" disabled="disabled"/><label for="ckbReqLastName">Required?</label>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <section>      
        ...
        <div class="full-width">
            ...
            <div class="radio-container">
                <input id="rblConfirmationPg_0" type="radio" name="rblConfirmationPg" value="Y" onclick="javascript:setTimeout(&#39;__doPostBack(\&#39;rblConfirmationPg$0\&#39;,\&#39;\&#39;)&#39;, 0)" /><label for="rblConfirmationPg_0">Yes</label>
                <input id="rblConfirmationPg_1" type="radio" name="rblConfirmationPg" value="N" onclick="javascript:setTimeout(&#39;__doPostBack(\&#39;rblConfirmationPg$1\&#39;,\&#39;\&#39;)&#39;, 0)" /><label for="rblConfirmationPg_1">No (Use the default)</label>
            </div>
        </div>
        <div class="full-width">
    ...
    <h3><span class="number">7.</span>Setup the Premium</h3> 
    <section>      
        <div class="full-width">
            <textarea name="ucPrizesCtl$txtGPDescription" rows="4" cols="20" id="ucPrizesCtl_txtGPDescription" maxlength="600"></textarea>
            <span class="question">Premium description - Characters remaining <span id="gpDiv">0</span></span>
        </div>
        <div class="full-width">
            <input name="ucPrizesCtl$txtGP_ARV" type="text" maxlength="15" id="ucPrizesCtl_txtGP_ARV" placeholder="ex. 250.09" />
            <span class="question">Premium Approx. Retail Value (numbers only)</span>
        </div>
        <div class="full-width">
            <input name="txtUploadLabelText" type="text" maxlength="100" id="txtUploadLabelText" placeholder="ex. Upload Your Receipt">
            <span class="question">*Enter Text To Describe What the User is Uploading</span>
        </div>
        <hr>
        <div class="full-width">
            <span class="question">*What file types will this promotion accept?</span>
            <div class="radio-container radio-two-col">
                <div>
                    <input id="cklFileTypes_0" type="checkbox" name="cklFileTypes$0" /><label for="cklFileTypes_0">Jpg, Jpeg</label>
                </div>
                <div >
                    <input id="cklFileTypes_1" type="checkbox" name="cklFileTypes$1" /><label for="cklFileTypes_1">Tif, Tiff</label>
                </div>
                <div>
                    <input id="cklFileTypes_2" type="checkbox" name="cklFileTypes$2" /><label for="cklFileTypes_2">Bmp</label>
                </div>
                <div >
                    <input id="cklFileTypes_3" type="checkbox" name="cklFileTypes$3" /><label for="cklFileTypes_3">Gif</label>
                </div>
                <div>
                    <input id="cklFileTypes_4" type="checkbox" name="cklFileTypes$4" /><label for="cklFileTypes_4">Pdf</label>
                </div>
                <div>
                    <input id="cklFileTypes_5" type="checkbox" name="cklFileTypes$5" /><label for="cklFileTypes_5">Png</label>
                </div>
                <div>
                    <input id="cklFileTypes_6" type="checkbox" name="cklFileTypes$6" /><label for="cklFileTypes_6">Doc, Docx</label>
                </div>
            </div>
        </div>
    </section>
    <h3><span class="number">8.</span>Contact Information</h3>
    <section>
        <div class="full-width">
        ...
        <div class="bottom-links">
            <a href="form-upload.php">Clear page</a>
