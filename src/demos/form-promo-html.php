...
<body>
    ...
    <div class="main">
    <h2>Promo -
        <span id="lblHeading">HTML</span></h2>
    ...
    <h3><span class="number">9.</span>Form Details</h3>
    <section>
        <div class="full-width">
            <input name="txtHostingURL" type="text" maxlength="250" id="txtHostingURL" placeholder="ex. http://www.SwoonReads.com/sweepstakes">
            <span class="question">*I am hosting the sweepstakes at this URL</span>
        </div>
        <div class="full-width">
            <input name="txtSubmitButtonText" type="text" maxlength="15" id="txtSubmitButtonText" placeholder="ex. Subscribe">
            <span class="question">*What do you want the submit button to read?</span>
        </div>
    </section>
    <h3><span class="number">10.</span>Contact Information</h3>
    <section>
        <div class="full-width">
        ...
        <div class="bottom-links">
            <a href="form-promo-html.php">Clear page</a>
